...
?>
				...
				?>
								...
								<p>
									<form action="scripts/upgrade_server.php?id=<?php echo($hardware['id'])?>" method="post">
					...
					<div id="add" class="modal">
						...
						<div class="modal-content">
							...
							<div class="modal-body">
								...
								<p>Select a bank account to pay with from the following list:</p>
								<form action="scripts/add_server.php" method="post">
					...
					<div id="internet" class="modal">
						...
						<div class="modal-content">
							...
							<?php 
								...
								<p>Select a bank account to pay with from the following list:</p>
								<form action="scripts/upgrade_internet.php?id=<?php echo($internet_level)?>" method="post">
