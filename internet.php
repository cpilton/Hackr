...
require 'scripts/update_known_list.php';
...
<banner>
	...
	$get_level->execute();
			...
			<div class="progress" style="margin: auto">
					...
					<meta http-equiv="refresh" content="<?php echo($seconds);?>;url=scripts/crack_ip.php?success=<?php echo($view_ip)?>" />
			</section>
			</section>
		</section>
		...
		<section id="search">
			...
			<tr>
				...
				<a href="scripts/web_logout.php">Logout</a>
				</td>
				</tr>
				</table>
	...
	$log = $log->fetch();
		...
		while ($log = $logs->fetch()) {
			...
			?>
				...
				<h2>Log File</h2>
				<form action="scripts/edit_log.php?log=<?php echo($log['id'])?>" method="post">
				...
				if ($get_software['user_id'] == $view_id && ($get_software['hidden'] == 'no' || $get_software['hider_level'] < $seeker_level)) { ?>
					...
					if ($get_software['size'] < 1000) {
						...
						<span class="tooltiptext">Download</span>
							<a href="scripts/download_software.php?id=<?php echo($get_software['id'])?>"><img src="img/download_icon.png" height="16px"></a>
							<?php } else { ?>
	...
	<container id="browser">
		...
		<section id="login_box">
			<form action="login_check.php" method="post">
				...
				<a href="scripts/crack_ip.php?ip=<?php echo($view_ip)?>" id="submit">Crack</a>
		</section>
<?php
					...
					<div id="upload" class="modal">
						...
						<div class="modal-content">
							...
							<div class="modal-body">
								...
								<form action="scripts/upload_software.php" method="post">
