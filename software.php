...
$bank = $DBH->prepare( 'SELECT id, user_id, amount, bank_name FROM finance ');
	...
	$bank = $bank->fetchAll();
				...
				<td width="5%" class="tooltip">
						...
						<a href="run_software.php?id=<?php echo($get_software['id'])?>"><img src="img/run_icon.png" height="16px"></a>
						<?php } else { ?>
...
<div id="myModal<?php echo($get_software['id'])?>" class="modal">
						...
						<div class="modal-content">
							...
							<div class="modal-body">
								...
								<form action="upgrade_software.php?software=<?php echo($get_software['id'])?>" method="post">
