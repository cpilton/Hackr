		...
		<table class="task_boxes">
			<tr>
				<th colspan="2">
					<p style="display: inline-block">
						<?php echo " " . $task[ "task_type" ] . " "; ?> </p> <a href="delete_task.php?id=<?php echo($task[ "id" ]) ?>"><img src="img/delete_icon.png" height="20px" style="float:right; display: inline-block;"></a>
				</th>
			</tr>
			<tr>
				<th colspan="2">
			...
			<tr>
				<td colspan="2">
					...
					<a href="task_finish.php?task=<?php echo $id?>">
